...
\Section{Rechercher}
	...
	\textbf{Résultat}~: la position où a été trouvé la valeur ou la position où elle aurait dû être

		\begin{LDA}
				\LComment{Recherche un étudiant.}
				\LComment{- trouvé~: indique si oui ou non il a été trouvé}
				\LComment{- pos~: indique la position où a été trouvé la valeur ou la position où elle aurait dû être}
				\Algo{rechercher}{
