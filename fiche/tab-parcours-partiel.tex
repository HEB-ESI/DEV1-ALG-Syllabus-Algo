...
\Section{Solution}
	...
	\subsubsection*{[A] Sans variable booléenne}
		...
		\begin{LDA}
			\Algo{tousPositifs}{\Par{tab}{\Array{n}{entiers}}}{booléen}
				\Decl{i}{entier}
				\Let i \Gets 0
				\While{i < n ET tab[i] $\neq$ 0}
					\Let i \Gets i + 1
	...
	\subsubsection*{[B] Avec variable booléenne}
		...
		qui nous à permis d'arrêter mais le suivant.
		...
		Dans le cas où on vérifie si tous les élements possèdent 
		une certaine propriéte (être positifs par exemple),
...
\Section{Alternatives}
	...
	\begin{minipage}{4.5cm}
		...
		que le parcours ne sera pas toujous complet.
	\end{minipage}
