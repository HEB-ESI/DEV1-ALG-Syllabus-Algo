...
%=================================
	...
	%=================================
		...
		\subsection*{Qui est en tête~?}
			...
			\begin{LDA}
			\Entete{enPremièrePosition}{\Par{positionsJoueurs\In}{\Array{m}{entiers}}}{entier}
			\end{LDA}
		...
		\subsection*{Jouer un tour de jeu}
			...
			\begin{LDA}
			\Entete{jouer}{
				\Par{chemin\In}{\Array{n}{entiers}},
				\Par{positionsJoueurs\InOut}{\Array{m}{entiers}},
				\Par{joueurCourant\In}{entier},
				\Par{valeurDé\In}{entier}
				}{}
			\end{LDA}
		
			Cet algorithme fait changer de position le joueur d’indice
			\textit{joueurCourant} de la valeur donnée par le dé (\textit{valeurDé}) en
