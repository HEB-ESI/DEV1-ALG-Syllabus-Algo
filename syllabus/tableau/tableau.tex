...
%======================
	...
	% ==================
		...
		\begin{LDA}
			...
			\RComment{l'élément d'indice i est initialisé à la valeur i}
		\end{LDA}
	...
	% ==============================
		...
		%------------------------------------------
			...
			\item \In\Out :
				...
				\begin{LDA}
					\LComment{Inverser le signe des éléments du tableau}
					\Algo{opposé}{\Par{tab\In\Out}{\Array{10}{entiers}}}{} 
						\For{i}{0}{9}
