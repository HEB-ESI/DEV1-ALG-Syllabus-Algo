...
%=============================
	...
	%================================================
		...
		%----------------------------------------------
		\subsection{Exercices de traçage}
		%-----------------------------------------
...
\clearpage			
		...
		\label{prem-ex-cplx}
			...
			\item
				De vérifier votre solution sur les exemples choisis.
			\end{enumerate}
			...
			\begin{Exercice}{Nombre multiple de 5}
				...
				\hline 
				1 & 4   & faux & faux & $\checkmark$ \\\hline
				2 & 15  & vrai & vrai & $\checkmark$ \\\hline
				3 & 0   & vrai & vrai & $\checkmark$ \\\hline
				4 & -10 & vrai & vrai & $\checkmark$ \\\hline
				\end{tabular}
				\end{center}
			\end{Exercice}
