	...
	%================================================
		...
		%=================================
			...
			\begin{Emphase}
				...
				\hline 
				1 & 3   & 2 & 6   & 6   & $\checkmark$ \\\hline
				2 & 3.5 & 1 & 3.5 & 3.5 & $\checkmark$ \\\hline
				\end{tabular}
				\end{center}				
			\end{Emphase}
		...
		%-------------------------------------------
			...
			Vus pouvez vous baser sur la fiche \vref{fiche:calcul-simple} 
			...
			\begin{Exercice}{Somme de 2 nombres}
				...
				\begin{center}
					...
					\hline 
					1 & 3    & 2   & 5   & 5   & $\checkmark$ \\\hline
					2 & -3   & 2   & -1  & -1  & $\checkmark$ \\\hline
					1 & 3    & 2.5 & 5.5 & 5.5 & $\checkmark$ \\\hline
					2 & -2.5 & 2.5 & 0   & 0   & $\checkmark$ \\\hline
					\end{tabular}
				\end{center}				
			\end{Exercice}
...
\clearpage
		...
		%-----------------------------------------
			...
			\begin{Exercice}{Calcul de vitesse}
				Testez cet algorithme en l'\emph{exécutant} 
				sur des valeurs concrètes.
				\begin{LDA}[1]
				\LComment{Calculer la vitesse (en km/h) d'un véhicule dont on donne}
				\LComment{la durée du parcours (en secondes) et la distance parcourue (en mètres).}
...
\clearpage			
			...
			Lorsqu'on écrit une expression mélant les opérateurs logiques,
			...
			Vous pouvez toujours ajouter des parenthèses inutiles
		...
		\label{prem-ex-cplx}
			...
			\item
				De tracer votre solution sur des exemples numériques
				pour le vérifier.
			\end{enumerate}
