...
%======================
	...
	% ==============================
		...
		Un tableau peut être passé en paramètre à un module 
		...
		est déclarée avec une variable 
		(qui peut être considéré comme un paramètre entrant).
	
		\textbf{Exemple~:}
		
		\begin{LDA}
			\Algo{brol}{\Par{tab}{\Array{n}{entiers}}}{}
				\Write "J’ai reçu un tableau de ", n, " éléments".
			\EndAlgo
		\end{LDA}
	
		Ce $n$ va prendre la taille précise du tableau
		utilisé à chaque appel et peut être utilisé
		dans le corps du module. 	
		Notons qu’on admet également qu’un module retourne un tableau. 
		
		\begin{LDA}
		\LComment Crée un tableau d'entiers de taille 10, l'initialise à 0 et le retourne.
		\Algo{créerTableau}{}{\Array{n}{entiers}}
		...
		Par contre, on ne peut pas lire ou afficher un tableau 
		en une seule instruction; 
		il faut des instructions de lecture 
		ou d'affichage individuelles pour chacun de ses éléments.
