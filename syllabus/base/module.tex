...
%===================
	...
	on va plutôt y faire référence c'est-à-dire
	appeler l'algorithme \lda{max2}. 
	Ce qui donne :
...
%=======================
	...
	%==================================
		...
		\begin{minipage}{8cm}
			\begin{LDA}[1]
				\LComment {Code appelé}
				\Algo{max3}{\Par{a\In}{réel}, \Par{b\In}{réel}, \Par{c\In}{réel}}{réel}
					\Decl{maxab, max}{réels}
					\Let maxab \Gets max2(a,b)
					\Let max \Gets max2(maxab,c)
					\Return max
		...
		\\
		\begin{minipage}{12cm}
			\begin{tabular}{|>{\centering\arraybackslash}m{2cm}|*{5}{>{\centering\arraybackslash}m{2cm}}|}
				\hline
				\verb_max3(3,2,5)_ & {a} & {b} & {c} & {maxab} & {max}\\
				\hline
				2 & {3}	& {2}	& {5}	& {\verb_#_}		& {\verb_#_}	 \\
				3 & {3}	& {2}	& {5}	& {indéfini}		& {indéfini}	 \\
				4 & {3}	& {2}	& {5}	& {3}		& {indéfini}	 \\
				5 & {3}	& {2}	& {5}	& {3}		& {5}	\\
				\hline
			\end{tabular}
	...
	%==================================
		...
		\begin{LDA}[1]
			\Algo{versHMS}{\Par{totalSec\In}{entier}, \Par{heuresÉcoulées\Out}{entier}, 
						   \Par{minutesÉcoulées\Out}{entier}, \Par{secondesÉcoulées\Out}{entier}}{}
		...
		\\\lda{heure \Gets heuresÉcoulées}, \lda{minute \Gets minutesÉcoulées} et \lda{seconde \Gets secondesÉcoulées}.
