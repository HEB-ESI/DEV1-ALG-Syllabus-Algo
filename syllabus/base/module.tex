...
%===================
	...
	\begin{figure}[!h]
		...
		\begin{center}
		\includegraphics[width=0.5\textwidth]{image/fig-params-entrants}  
	    \caption{Paramètres entrants: affectation de $a$, $b$, $c$ au \textbf{début} de \textit{max3}.}
	    \label{fig:parin}
		\end{center}
	\end{figure}
	...
	\begin{figure}[!h]
		\begin{center}
\includegraphics[width=1\textwidth]{image/fig-params-sortants}  
	    \caption{Paramètres sortants: affectation de $heure$, $minute$, $seconde$ à la  \textbf{fin} de \textit{versHMS}.}
	    \label{fig:parout}
		\end{center}
	\end{figure}
	...
	\begin{figure}[!h]
		\begin{center}
		\includegraphics[width=0.35\textwidth]{image/fig-params-ES}
	    \caption{Paramètres entrant-sortants: affectation de $nb$ au \textbf{début} de \textit{valAbsolue} et de $température$ à la  \textbf{fin} de \textit{valAbsolue}.}
	    \label{fig:parinout}
		\end{center}
	\end{figure}
