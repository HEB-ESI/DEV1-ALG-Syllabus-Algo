...
La figure~\ref{fig:passage-parametres} résume de manière graphique les trois types de passage de paramètres.

\begin{figure}


\begin{centering}
\subfloat[Paramètre entrant]{\protect\begin{centering}
\protect\includegraphics[width=0.8\textwidth]{../../image/figure-paramètres-entrants}\protect
\par\end{centering}
...
\begin{centering}
\subfloat[Paramètre sortant]{\protect\begin{centering}
\protect\includegraphics[width=0.8\textwidth]{../../image/figure-paramètres-sortants}\protect
\par\end{centering}
...
\begin{centering}
\subfloat[Paramètre entrant-sortant]{\protect\centering{}\protect\includegraphics[width=0.8\textwidth]{../../image/figure-paramètres-entrant-sortants}\protect}
\par\end{centering}

\protect\caption{\label{fig:passage-parametres}Les trois diffèrents types de passages
de paramètres}
